...
<ul class="nav flex-column">
	...
	<li class="nav-item mb-2">
		<h6 class="text-white">
			...
			<a class="text-white" href="/servletjsp/exam06/ContentController">상태 유지 - Cookie(클라이언트 측 저장)</a>
		</h6>
	</li>
	...
	<li class="nav-item mb-2">
		<h6 class="text-white">
			...
			<a class="text-white" href="/servletjsp/exam07/ContentController">상태 유지 - HttpSession(서버 측 저장, 해당 클라이언트)</a>
		</h6>
	</li>
	...
	<li class="nav-item mb-2">
		<h6 class="text-white">
			...
			<a class="text-white" href="/servletjsp/exam08/ContentController">상태 유지 - ServletContext(서버 측 저장, 모든 클라이언트)</a>
		</h6>
	</li>
