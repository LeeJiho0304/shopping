...
<head>
    ...
    <title>OTI전자 관리자 페이지</title>

    <!-- Custom fonts for this template-->
    <link href="/shopping/resources/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Content Wrapper -->
        <div id="content-wrapper" class="d-flex flex-column" style="height: auto; min-height: 100%;">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Lee Jiho</span>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                add Product</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">상품 등록</div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-pen-to-square fa-2x text-gray-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
	                        ...
	                        <div class="card-body">
	                        	<div class="members pt-4 pb-2">
	                        		<ul class="users-list clearfix">
										<li>
										<img src="/shopping/images/adminimg.png" alt="User Image">
										<span>이지호</span>
										</li>
            ...
            <!-- Footer -->
            <footer class="sticky-footer bg-white" style=" transform : translateY(-100%);">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; 2022 OTI전자</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
