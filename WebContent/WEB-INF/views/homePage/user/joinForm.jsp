				...
				<div class="card-body">
					<form method="post" class="validation-form"
						...
						<div class="mb-3">
							...
							id="uid" name="uid" placeholder="소문자 포함한 6~10글자" required>
						</div>
						<div class="mb-3">
							<label for="password">비밀번호</label> 
							<input type="password" class="form-control"
							 id="password" name="pw" placeholder="대, 소문자포함 8~15글자" required>
						</div>

						<div class="row">
							<div class="col-md-6 mb-3">
								<label for="name">이름</label> <input type="text"
									class="form-control" id="name" placeholder="홍길동" name="name" required>
								<div class="invalid-feedback">이름을 입력해주세요.</div>
							</div>
							<div class="col-md-6 mb-3">
								<label for="phone">전화번호</label> <input type="text"
									class="form-control" id="phone" name="phone" placeholder="000-0000-0000" value=""
									required>
						...
						<div class="row">
							<div class="col-md-4 mb-3">
								<input type="text" class="form-control" id="year"
									placeholder="년(4자리)" name="year" required>
							</div>
							<div class="col-md-4 mb-3">
								<input type="text" class="form-control" id="month"
									placeholder="월" name="month" required>
							</div>
							<div class="col-md-4 mb-3">
