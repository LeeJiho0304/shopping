					...
					<div class="lnb lnb-new">
						<ul class="mypage-lnb">
							<li>
								...
								<ul class="my-sub">
									<li>
										<a href="javascript:requestContent('/shopping/user/orderList.html')" class="my-dep2">주문 조회</a>
									</li>
								</ul>
							</li>
							<li>
								...
								<ul class="my-sub">
									<li>
										<a href="javascript:requestContent('/shopping/user/updateUser.html')" class="my-dep2">회원정보 수정</a>
									</li>
									<li>
