		...
		<section class="h-100 h-custom">
		  <div class="container h-100 py-5">
		    <div class="row d-flex justify-content-center align-items-center h-100">
		          ...
		          <table class="table">
		            ...
		            <tbody>
		               ...
		               <td>
		                ...
		                <td scope="row">
		                  <div class="d-flex align-items-center">
		                    <img src="../images/올레드1.jpg" class="img-fluid rounded-3"
		                      style="width: 120px;" alt="Book">
		                    <div class="flex-column ms-4">
		                      <p class="mb-2">올레디 오브제 컬렉션 </p>
		                      <p class="mb-0">상품명 djae</p>
		                    </div>
		                  </div>
		                </td>
		                ...
		                <td class="align-middle">
		                  <p class="mb-0" style="font-weight: 500;">3,090,000</p>
		                </td>
		              </tr>
		              <tr>
		              <td>
		               <input type='checkbox'
		                ...
		                <td scope="row" class="border-bottom-0">
		                  <div class="d-flex align-items-center">
		                    <img src="../images/올레드1.jpg" class="img-fluid rounded-3"
		                      style="width: 120px;" alt="Book">
		                    <div class="flex-column ms-4">
		                      <p class="mb-2">스탠바이미</p>
		                      <p class="mb-0">상품명 dage</p>
		                    </div>
		                  </div>
		                </td>
		                ...
		                <td class="align-middle border-bottom-0">
		                  <p class="mb-0" style="font-weight: 500;">2,790,000</p>
		                </td>
		              </tr>
		              ...
		              <td>
		              	...
		              	<p style="font-weight: 500;  font-size:20px;">2</p>
		              </td>
		              <td><p style="font-weight:1000; font-size:15px;">결제예정금액</p>
		              <p style="font-weight: 500; color:red; font-size:20px;" >3,680,000</p></td>
		              </tr>
              ...
              <button type="button" class="w-btn w-btn-red">
            	   구매하기
              </button>
